          ...
          <div className="mt-10" >
            <h4 className="text-base md:text-lg">
              ...
              <span className="font-bold">
                Shemil Kaweesha
              </span> , a code-wrangling, guitar-strumming Software Engineer. When I’m not deep into {' '}
              <span className="font-bold">
                TypeScript
              </span> {' '}
              or figuring out why my {' '}
              <span className="font-bold" >
                React
              </span> {' '}
              app won’t render (again), you’ll find me jamming out on my {' '}
              <span className="font-bold" >guitar</span>
              , pretending I’m the next rock star — minus the world tour.
            </h4>
            <br />
            <h4 className="text-base md:text-lg" >
              ...
              And no, I don’t run on coffee like the stereotypical dev — I’m more of a “give me good vibes and snacks” kind of guy. Let’s build something awesome together — or at least laugh at my code.
            </h4>
          </div>
